...
/*   Updated: 2021/02/13 10:14:12 by hna              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
public:
	...
	void	doBureaucracy(std::string const &name, std::string const &target) throw(noOfficeMemberException, Form::NotSignedException, Form::GradeTooLowException);
